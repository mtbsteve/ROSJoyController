...
import com.ROSJoyController.fragments.About_Fragment;
import com.ROSJoyController.fragments.Home_Fragment;
import com.ROSJoyController.R;
import com.ROSJoyController.fragments.ROS_Settings_Fragment;
        ...
        navigationView.setNavigationItemSelectedListener(menuItem -> {
            ...
            switch (id) {
                case R.id.game_controller:
                    ToastMaker("Select Controller");
                    loadFragment(mHomeFragment);
                    break;
                case R.id.settings:
                    ToastMaker("UI Settings");
                    startActivity(new Intent(this, CyaneaSettingsActivity.class));
                    break;
                case R.id.about:
                    ToastMaker("About this App");
                    loadFragment(mAboutFragment);
                    break;
                case R.id.ros_settings:
                    ToastMaker("ROS Settings");
                    loadFragment(mROSettingsFragment);
                    break;
            }
